...
const app = express();
app.set('trust proxy', 1); // Required for Vercel — fixes X-Forwarded-For validation error
...
const aiLimiter = rateLimit({
    windowMs: 60_000,
    max: 20,
    validate: { xForwardedForHeader: false }, // Prevents crash on Vercel proxy headers
